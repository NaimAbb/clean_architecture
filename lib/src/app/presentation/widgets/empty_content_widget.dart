...
import 'package:clean_architecture/src/app/presentation/widgets/app_button_widget.dart';
import 'package:clean_architecture/src/core/assets/assets_constants.dart';
import 'package:clean_architecture/src/core/extentions.dart';
import 'package:clean_architecture/src/core/styles/text_styles_constants.dart';
...
class EmptyContentWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        // Lottie.asset(
        //   AssetsConstants.emptyContentAnimation,
        //   height: 150.h,
        // ),
        5.verticalSpace,
        Text(
